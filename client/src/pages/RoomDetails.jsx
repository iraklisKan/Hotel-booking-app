...
const RoomDetails = () => {
    ...
    useEffect(() => {
        ...
        room && setCurrentPrice(room.pricePerNight);
    }, [id])
  ...
  return room &&(
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col lg:flex-row   mt-6 gap-6'>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length > 1  && room.images.map((image,index) => (
                    <img onClick={() => {setMainImage(image); setCurrentPrice(room.pricePerNight - (index * 50))}}
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            ...
            <p className='text-2xl font-medium'>${currentPrice}/night</p>
        </div>
        <div>
            ...
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10
               ...
               <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
                ...
                transition-all text-white rounded-md max-md:wifull max-md:mt-6 md:px-25 py-3 md:py-4
            ...
            <div>
                <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                    Guests will be allocated on the ground floor accordingly to availability.
                    ...
                    guests to get the exact price for groups.The Guests will be allocated ground floor according to availability.
                    You get the comfortable two bedroom  apartmentthat has a true
                    city feeling
                </p>
            </div>
