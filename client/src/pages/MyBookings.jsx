...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 md:pb-38 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="My Bookings"
        subTitle="Esily manage your past, current, and upcoming hotel reservations
          ...
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                ...
                <div className="flex items-center gap-1 text-sm text-gray-500">
                  <img src={guestsIcon} alt="guests-icon" />
            ...
            <div className="flex flex-row md:items-center md:gap-12 mt-3 gap-8">
              <div>
                <p>Check-In:</p>
                <p className="classname=text-gray-500 text-sm"></p>
            ...
            {/*payment info */}
            <div className="flex flex-col items-start justifu-center pt-3">
              ...
              {!booking.isPaid && (
                <button className="px-4 py-1.5 text-xs border border-gray-400 rounded-full hover:bg-gray-50 
