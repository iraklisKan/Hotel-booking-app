...
const Navbar = () => {
    ...
    return (
            ...
            <nav className={`fixed left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${
                ...
                {/* Logo */}
                <Link to = "/">
                    <img src={logo} alt="search" className={`h-9 ${isScrolled && "invert opacity-80"}`} />
                </Link>
                ...
                <div className="hidden md:flex items-center gap-4">
                    <img src={searchIcon} alt="search"  className={`${isScrolled && 'invert'} h-7 translation-all duration-500`}/>
                ...
                <div className="flex items-center gap-3 md:hidden">
                    ...
                    <img onClick={()=>setIsMenuOpen(!isMenuOpen)} src = {menuIcon} alt = "" className={`${isScrolled && 'invert'} h-4 translation-all duration-500`}/>
